...
int main() {
    ...
    pointToPoint.SetDeviceAttribute("DataRate", StringValue("5000bps"));//500bps
    ...
    tch.Install(devices);
    QueueSize queueSize = QueueSize("200B"); //200B
    ...
    std::vector<int> packet_count = {2000, 200 , 200, 200, 200, 200, 200, 200, 200, 200}; 
    // packet大小以及數量
